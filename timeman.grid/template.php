...
Asset::getInstance()->addCss('/bitrix/js/intranet/design-tokens/bitrix24/bitrix24-design-tokens.css');
...
<input type="submit" name="button1" id="ui-btn-main"
                class="ui-btn-main" value="Скачать XLS" /> 
...
if($_POST['button1']) { 
	require_once('/home/bitrix/www/local/templates/lk_copy/components/bitrix/timeman.worktime.grid/.default/export.php');
        } 
